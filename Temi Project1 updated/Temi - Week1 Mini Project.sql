...
CREATE TABLE Payment (
	...
	Amount INT NOT NULL,
	PRIMARY KEY (ProductID, CustomerID, PaymentID),
	FOREIGN KEY (CustomerID) REFERENCES Customer(CustomerID)
	);
...
--Queries--
--update minimum of three rows--
--update Customer Table--
	UPDATE Customer
	SET FirstName = 'Sandor', LastName = 'Clegane', Email = 'sclegane@gmail.com', CustomerAddress = 'Casterly Rock'
	WHERE CustomerID = 005;

	UPDATE Customer
	SET FirstName = 'Stannis', LastName = 'Baratheon', Email = 'sbaratheon@gmail.com', CustomerAddress = 'Storms End'
	WHERE CustomerID = 004;

	UPDATE Customer
	SET FirstName = 'Robert', LastName = 'Baratheon', Email = 'rbaratheon@gmail.com', CustomerAddress = 'Kings Landing'
	WHERE CustomerID = 003;

--Insert prior data points into the database--

	INSERT INTO Customer (CustomerID, FirstName, LastName, Email, PhoneNumber, CustomerAddress)
	VALUES (006, 'Bryon', 'Stark', 'bstark@gmail.com', '215-685-7789', 'Winterfell');

	INSERT INTO Customer (CustomerID, FirstName, LastName, Email, PhoneNumber, CustomerAddress)
	VALUES (007, 'Arya', 'Stark', 'astark@gmail.com', '215-985-7789', 'Winterfell');

	INSERT INTO Customer (CustomerID, FirstName, LastName, Email, PhoneNumber, CustomerAddress)
	VALUES (008, 'John', 'Tully', 'jtully@gmail.com', '215-685-7987', 'The Midlands');
